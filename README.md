# 🏸 Community Badminton Cup — Live Tournament Portal

A modern, responsive, mobile-first web portal for managing community badminton tournaments with a 9-round mixer format, 18 players, automatic referee rotations, real-time leaderboard rankings, and dynamic Stage 2 Finals seeding.
...
1. Create a new repository on GitHub (e.g. `community-badminton-cup`).
...
3. In your GitHub repository:
   ...
   - Click **Save**.
4. Within 1–2 minutes, your portal will be live at:
   ```
   https://<your-username>.github.io/community-badminton-cup/
   ```
...
git init
git add .
git commit -m "Initial commit: Community Badminton Cup tournament portal"
git branch -M main
git remote add origin https://github.com/<your-username>/community-badminton-cup.git
git push -u origin main
```

Then enable GitHub Pages under **Settings &rarr; Pages**. An automated GitHub Actions workflow (`.github/workflows/deploy.yml`) is also included if you prefer GitHub Actions deployment!
